...
def imageOps(func_name, image, label, mask, img_des_path, label_des_path, mask_des_path, img_file_name, label_file_name,
    ...
    for _i in range(0, times):
        ...
        DataAugmentation.saveImage(new_mask, os.path.join(mask_des_path, func_name + str(_i) + mask_file_name))
...
if __name__ == '__main__':
    ...
    threadOPS("DRIVE/training/images1",  # set your path of training images
              "DRIVE/aug/images",
              "DRIVE/training/1st_manual",  # set your path of training labels
              "DRIVE/aug/1st_manual",
              "DRIVE/training/mask",  # set your path of training mask
              "DRIVE/aug/mask")
